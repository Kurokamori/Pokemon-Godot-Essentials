# Pokemon Godot Essentials
This is Pokemon Godot Essentials, a semi-faithful port of the RPG Maker XP 'Pokemon Essentials' to Godot with ground-up reworking of all functionality to be as Godot-native as possible, while keeping a lot of the original tags, notations, and implementations.

This was created by Kurokamori as a tool for my own development and is generally a personal project, but you are welcome to use it and contribute to it if you'd like.

# Usage
You can fork the repository directly to build on top of, this allows you to get updates as they are made the repository without having to manually download them.

This is a template project that aims to give you everything you need to create your own Pokemon fangame in Godot

This is essentially a standard Godot Project with a lot of bells and whistles,
Currently everything is still pretty script heavy but I hope to create addons to make it easier to edit.

A lot of the game can be editted by editting corresponding .tres or .tscn files.

# Credits
I want to say thank you to the people and projects that were able to make this possibe:

Of course credit to the original `Pokemon Essentials` for being an amazing tool and serving as the skeleton for this project.  
Also credit to `Pokemon Essentials` for the majority of the graphics assets this project ships with.  

Credit to the following for the Gen 9 Pack which was also used for graphics and mechanical reference :  
...
-PLZA sprites - Caruban, ace_stryfe, KingOfThe-X-Roads, camiloveso, Mak  
...
And lastly of course, credit to Gamefreak and the Pokemon Company for giving us such a wonderful franchise.  
All creatures, mechanics, and otherwise belong to Gamefreak and the Pokemon Company.  
